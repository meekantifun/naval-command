...
// ── DESTROYERS ──────────────────────────────────────────────────────────────────
        ...
        this.aiTypes.set('abyssal_i_class', {
            ...
            tonnage: 1800,
            speedKnots: 36,
            armorThickness: { belt: 12, deck: 8, turret: 6 },
            baseAccuracy: 73,
            stats: {
                health: this.calculateHP(1800, 'Destroyer'),
                armor: this.calculateArmor(12, 8, 6),
                speed: this.calculateSpeed(36),
        ...
        this.aiTypes.set('abyssal_ha_class', {
            ...
            tonnage: 2100,
            speedKnots: 34,
            armorThickness: { belt: 16, deck: 11, turret: 9 },
            baseAccuracy: 75,
            stats: {
                health: this.calculateHP(2100, 'Destroyer'),
                armor: this.calculateArmor(16, 11, 9),
        ...
        this.aiTypes.set('abyssal_ha_class_elite', {
            ...
            tonnage: 2300,
            speedKnots: 35,
            armorThickness: { belt: 19, deck: 13, turret: 11 },
            baseAccuracy: 80,
            stats: {
                health: this.calculateHP(2300, 'Destroyer'),
                armor: this.calculateArmor(19, 13, 11),
                speed: this.calculateSpeed(35),
        ...
        this.aiTypes.set('abyssal_ni_class', {
            ...
            tonnage: 2300,
            speedKnots: 33,
            armorThickness: { belt: 14, deck: 9, turret: 8 },
            baseAccuracy: 74,
            stats: {
                health: this.calculateHP(2300, 'Destroyer'),
                armor: this.calculateArmor(14, 9, 8),
        ...
        this.aiTypes.set('abyssal_ni_class_elite', {
            ...
            tonnage: 2500,
            speedKnots: 34,
            armorThickness: { belt: 17, deck: 11, turret: 10 },
            baseAccuracy: 79,
            stats: {
                health: this.calculateHP(2500, 'Destroyer'),
                armor: this.calculateArmor(17, 11, 10),
                speed: this.calculateSpeed(34),
        ...
        this.aiTypes.set('abyssal_na_class_elite', {
            ...
            tonnage: 2600,
            speedKnots: 33,
            armorThickness: { belt: 21, deck: 14, turret: 12 },
            baseAccuracy: 82,
            stats: {
                health: this.calculateHP(2600, 'Destroyer'),
                armor: this.calculateArmor(21, 14, 12),
                speed: this.calculateSpeed(33),
...
// ── LIGHT CRUISERS ───────────────────────────────────────────────────────────────
        ...
        this.aiTypes.set('abyssal_he_class_elite', {
            ...
            tonnage: 6500,
            speedKnots: 33,
            armorThickness: { belt: 28, deck: 17, turret: 18 },
            baseAccuracy: 84,
            stats: {
                health: this.calculateHP(6500, 'Light Cruiser'),
                armor: this.calculateArmor(28, 17, 18),
                speed: this.calculateSpeed(33),
        ...
        this.aiTypes.set('abyssal_ho_class', {
            ...
            tonnage: 5500,
            speedKnots: 33,
            armorThickness: { belt: 22, deck: 13, turret: 13 },
            baseAccuracy: 78,
            stats: {
                health: this.calculateHP(5500, 'Light Cruiser'),
                armor: this.calculateArmor(22, 13, 13),
                speed: this.calculateSpeed(33),
        ...
        this.aiTypes.set('abyssal_to_class', {
            ...
            tonnage: 7000,
            speedKnots: 31,
            armorThickness: { belt: 28, deck: 16, turret: 16 },
            baseAccuracy: 80,
            stats: {
                health: this.calculateHP(7000, 'Light Cruiser'),
                armor: this.calculateArmor(28, 16, 16),
        ...
        this.aiTypes.set('abyssal_to_class_elite', {
            ...
            tonnage: 7500,
            speedKnots: 32,
            armorThickness: { belt: 32, deck: 18, turret: 19 },
            baseAccuracy: 84,
            stats: {
                health: this.calculateHP(7500, 'Light Cruiser'),
                armor: this.calculateArmor(32, 18, 19),
                speed: this.calculateSpeed(32),
        ...
        this.aiTypes.set('abyssal_tsu_class', {
            ...
            tonnage: 6200,
            speedKnots: 32,
            armorThickness: { belt: 26, deck: 15, turret: 14 },
            baseAccuracy: 79,
            stats: {
                health: this.calculateHP(6200, 'Light Cruiser'),
                armor: this.calculateArmor(26, 15, 14),
                speed: this.calculateSpeed(32),
        ...
        this.aiTypes.set('abyssal_tsu_class_elite', {
            ...
            tonnage: 6800,
            speedKnots: 33,
            armorThickness: { belt: 30, deck: 17, turret: 16 },
            baseAccuracy: 83,
            stats: {
                health: this.calculateHP(6800, 'Light Cruiser'),
                armor: this.calculateArmor(30, 17, 16),
                speed: this.calculateSpeed(33),
        ...
        this.aiTypes.set('abyssal_chi_class', {
            ...
            tonnage: 7500,
            speedKnots: 30,
            armorThickness: { belt: 30, deck: 18, turret: 18 },
            baseAccuracy: 81,
            stats: {
                health: this.calculateHP(7500, 'Light Cruiser'),
                armor: this.calculateArmor(30, 18, 18),
        ...
        this.aiTypes.set('abyssal_chi_class_elite', {
            ...
            tonnage: 8200,
            speedKnots: 31,
            armorThickness: { belt: 34, deck: 20, turret: 21 },
            baseAccuracy: 85,
            stats: {
                health: this.calculateHP(8200, 'Light Cruiser'),
                armor: this.calculateArmor(34, 20, 21),
                speed: this.calculateSpeed(31),
...
// ── HEAVY CRUISERS ───────────────────────────────────────────────────────────────
        ...
        this.aiTypes.set('abyssal_ri_class_elite', {
            ...
            tonnage: 11000,
            speedKnots: 31,
            armorThickness: { belt: 44, deck: 22, turret: 28 },
            baseAccuracy: 85,
            stats: {
                health: this.calculateHP(11000, 'Heavy Cruiser'),
                armor: this.calculateArmor(44, 22, 28),
                speed: this.calculateSpeed(31),
        ...
        this.aiTypes.set('abyssal_ne_class', {
            ...
            tonnage: 12000,
            speedKnots: 29,
            armorThickness: { belt: 48, deck: 24, turret: 30 },
            baseAccuracy: 83,
            stats: {
                health: this.calculateHP(12000, 'Heavy Cruiser'),
                armor: this.calculateArmor(48, 24, 30),
        ...
        this.aiTypes.set('abyssal_ne_class_elite', {
            ...
            tonnage: 13000,
            speedKnots: 30,
            armorThickness: { belt: 52, deck: 26, turret: 33 },
            baseAccuracy: 87,
            stats: {
                health: this.calculateHP(13000, 'Heavy Cruiser'),
                armor: this.calculateArmor(52, 26, 33),
                speed: this.calculateSpeed(30),
...
// ── BATTLESHIPS ──────────────────────────────────────────────────────────────────
        ...
        this.aiTypes.set('abyssal_ru_class_elite', {
            ...
            tonnage: 38000,
            speedKnots: 24,
            armorThickness: { belt: 85, deck: 33, turret: 55 },
            baseAccuracy: 87,
            stats: {
                health: this.calculateHP(38000, 'Battleship'),
                armor: this.calculateArmor(85, 33, 55),
        ...
        this.aiTypes.set('abyssal_ta_class', {
            ...
            tonnage: 40000,
            speedKnots: 22,
            armorThickness: { belt: 88, deck: 35, turret: 58 },
            baseAccuracy: 86,
            stats: {
                health: this.calculateHP(40000, 'Battleship'),
                armor: this.calculateArmor(88, 35, 58),
        ...
        this.aiTypes.set('abyssal_ta_class_elite', {
            ...
            tonnage: 43000,
            speedKnots: 23,
            armorThickness: { belt: 93, deck: 37, turret: 62 },
            baseAccuracy: 89,
            stats: {
                health: this.calculateHP(43000, 'Battleship'),
                armor: this.calculateArmor(93, 37, 62),
                speed: this.calculateSpeed(23),
        ...
        this.aiTypes.set('abyssal_re_class', {
            ...
            tonnage: 50000,
            speedKnots: 21,
            armorThickness: { belt: 100, deck: 40, turret: 68 },
            baseAccuracy: 88,
            stats: {
                health: this.calculateHP(50000, 'Battleship'),
                armor: this.calculateArmor(100, 40, 68),
        ...
        this.aiTypes.set('abyssal_re_class_elite', {
            ...
            tonnage: 55000,
            speedKnots: 22,
            armorThickness: { belt: 108, deck: 43, turret: 72 },
            baseAccuracy: 91,
            stats: {
                health: this.calculateHP(55000, 'Battleship'),
                armor: this.calculateArmor(108, 43, 72),
                speed: this.calculateSpeed(22),
...
// ── AIRCRAFT CARRIERS ────────────────────────────────────────────────────────────
        ...
        this.aiTypes.set('abyssal_nu_class_elite', {
            ...
            tonnage: 17000,
            speedKnots: 29,
            armorThickness: { belt: 23, deck: 18, turret: 13 },
            baseAccuracy: 74,
            stats: {
                health: this.calculateHP(17000, 'Light Aircraft Carrier'),
                armor: this.calculateArmor(23, 18, 13),
                speed: this.calculateSpeed(29),
...
// ── SUBMARINES ────────────────────────────────────────────────────────────────
        ...
        this.aiTypes.set('abyssal_ka_class', {
            ...
            tonnage: 1200,
            speedKnots: 17,
            armorThickness: { belt: 20, deck: 12, turret: 8 },
            baseAccuracy: 80,
            stats: {
                health: this.calculateHP(1200, 'Submarine'),
                armor: this.calculateArmor(20, 12, 8),
        ...
        this.aiTypes.set('abyssal_ka_class_elite', {
            ...
            tonnage: 1400,
            speedKnots: 18,
            armorThickness: { belt: 23, deck: 14, turret: 10 },
            baseAccuracy: 84,
            stats: {
                health: this.calculateHP(1400, 'Submarine'),
                armor: this.calculateArmor(23, 14, 10),
        ...
        this.aiTypes.set('abyssal_yo_class', {
            ...
            tonnage: 1800,
            speedKnots: 18,
            armorThickness: { belt: 22, deck: 14, turret: 10 },
            baseAccuracy: 82,
            stats: {
                health: this.calculateHP(1800, 'Submarine'),
                armor: this.calculateArmor(22, 14, 10),
                speed: this.calculateSpeed(18),
        ...
        this.aiTypes.set('abyssal_yo_class_elite', {
            ...
            tonnage: 2000,
            speedKnots: 19,
            armorThickness: { belt: 25, deck: 16, turret: 12 },
            baseAccuracy: 86,
            stats: {
                health: this.calculateHP(2000, 'Submarine'),
                armor: this.calculateArmor(25, 16, 12),
        ...
        this.aiTypes.set('abyssal_so_class_elite', {
            ...
            tonnage: 2800,
            speedKnots: 20,
            armorThickness: { belt: 28, deck: 18, turret: 14 },
            baseAccuracy: 87,
            stats: {
                health: this.calculateHP(2800, 'Submarine'),
                armor: this.calculateArmor(28, 18, 14),
...
// ── BOSSES ────────────────────────────────────────────────────────────────────
        ...
        this.aiTypes.set('abyssal_destroyer_princess', {
            ...
            tonnage: 3500,
            speedKnots: 38,
            armorThickness: { belt: 25, deck: 18, turret: 15 },
            baseAccuracy: 88,
            stats: {
                health: this.calculateHP(3500, 'Destroyer'),
                armor: this.calculateArmor(25, 18, 15),
        ...
        this.aiTypes.set('abyssal_destroyer_demon', {
            ...
            tonnage: 4000,
            speedKnots: 40,
            armorThickness: { belt: 28, deck: 20, turret: 18 },
            baseAccuracy: 92,
            stats: {
                health: this.calculateHP(4000, 'Destroyer'),
                armor: this.calculateArmor(28, 20, 18),
        ...
        this.aiTypes.set('abyssal_light_cruiser_princess', {
            ...
            tonnage: 10000,
            speedKnots: 34,
            armorThickness: { belt: 40, deck: 25, turret: 25 },
            baseAccuracy: 88,
            stats: {
                health: this.calculateHP(10000, 'Light Cruiser'),
                armor: this.calculateArmor(40, 25, 25),
                speed: this.calculateSpeed(34),
        ...
        this.aiTypes.set('abyssal_light_cruiser_demon', {
            ...
            tonnage: 12000,
            speedKnots: 35,
            armorThickness: { belt: 45, deck: 28, turret: 28 },
            baseAccuracy: 91,
            stats: {
                health: this.calculateHP(12000, 'Light Cruiser'),
                armor: this.calculateArmor(45, 28, 28),
                speed: this.calculateSpeed(35),
        ...
        this.aiTypes.set('abyssal_heavy_cruiser_princess', {
            ...
            tonnage: 18000,
            speedKnots: 31,
            armorThickness: { belt: 65, deck: 30, turret: 38 },
            baseAccuracy: 89,
            stats: {
                health: this.calculateHP(18000, 'Heavy Cruiser'),
                armor: this.calculateArmor(65, 30, 38),
                speed: this.calculateSpeed(31),
        ...
        this.aiTypes.set('abyssal_heavy_cruiser_demon', {
            ...
            tonnage: 21000,
            speedKnots: 32,
            armorThickness: { belt: 72, deck: 34, turret: 42 },
            baseAccuracy: 92,
            stats: {
                health: this.calculateHP(21000, 'Heavy Cruiser'),
                armor: this.calculateArmor(72, 34, 42),
                speed: this.calculateSpeed(32),
        ...
        this.aiTypes.set('abyssal_anchorage_princess', {
            ...
            tonnage: 55000,
            speedKnots: 22,
            armorThickness: { belt: 110, deck: 45, turret: 72 },
            baseAccuracy: 91,
            stats: {
                health: this.calculateHP(55000, 'Battleship'),
                armor: this.calculateArmor(110, 45, 72),
                speed: this.calculateSpeed(22),
                evasion: this.calculateEvasion(22, 55000),
                range: 23,
                baseAccuracy: 91
        ...
        this.aiTypes.set('abyssal_anchorage_demon', {
            ...
            tonnage: 62000,
            speedKnots: 23,
            armorThickness: { belt: 118, deck: 50, turret: 78 },
            baseAccuracy: 93,
            stats: {
                health: this.calculateHP(62000, 'Battleship'),
                armor: this.calculateArmor(118, 50, 78),
                speed: this.calculateSpeed(23),
        ...
        this.aiTypes.set('abyssal_armored_carrier_princess', {
            ...
            tonnage: 35000,
            speedKnots: 24,
            armorThickness: { belt: 50, deck: 35, turret: 25 },
            baseAccuracy: 80,
            stats: {
                health: this.calculateHP(35000, 'Aircraft Carrier'),
                armor: this.calculateArmor(50, 35, 25),
                speed: this.calculateSpeed(24),
        ...
        this.aiTypes.set('abyssal_armored_carrier_demon', {
            ...
            tonnage: 40000,
            speedKnots: 25,
            armorThickness: { belt: 55, deck: 38, turret: 28 },
            baseAccuracy: 83,
            stats: {
                health: this.calculateHP(40000, 'Aircraft Carrier'),
                armor: this.calculateArmor(55, 38, 28),
                speed: this.calculateSpeed(25),
...
// ── DESTROYERS ────────────────────────────────────────────────────────────────────
        ...
        this.aiTypes.set('siren_mutsuki', {
            ...
            tonnage: 1445,
            speedKnots: 33,
            armorThickness: { belt: 10, deck: 6, turret: 5 },
            baseAccuracy: 72,
            stats: {
                health: this.calculateHP(1445, 'Destroyer'),
                armor: this.calculateArmor(10, 6, 5),
                speed: this.calculateSpeed(33),
        ...
        this.aiTypes.set('siren_shiratsuyu', {
            ...
            tonnage: 1685,
            speedKnots: 34,
            armorThickness: { belt: 13, deck: 8, turret: 6 },
            baseAccuracy: 75,
            stats: {
                health: this.calculateHP(1685, 'Destroyer'),
                armor: this.calculateArmor(13, 8, 6),
                speed: this.calculateSpeed(34),
        ...
        this.aiTypes.set('siren_yuugumo', {
            ...
            tonnage: 2077,
            speedKnots: 35,
            armorThickness: { belt: 16, deck: 10, turret: 8 },
            baseAccuracy: 77,
            stats: {
                health: this.calculateHP(2077, 'Destroyer'),
                armor: this.calculateArmor(16, 10, 8),
                speed: this.calculateSpeed(35),
        ...
        this.aiTypes.set('siren_kagerou', {
            ...
            tonnage: 2033,
            speedKnots: 35,
            armorThickness: { belt: 15, deck: 9, turret: 8 },
            baseAccuracy: 76,
            stats: {
                health: this.calculateHP(2033, 'Destroyer'),
                armor: this.calculateArmor(15, 9, 8),
                speed: this.calculateSpeed(35),
        ...
        this.aiTypes.set('siren_fubuki', {
            ...
            tonnage: 2090,
            speedKnots: 34,
            armorThickness: { belt: 14, deck: 9, turret: 7 },
            baseAccuracy: 76,
            stats: {
                health: this.calculateHP(2090, 'Destroyer'),
                armor: this.calculateArmor(14, 9, 7),
                speed: this.calculateSpeed(34),
        ...
        this.aiTypes.set('siren_mahan', {
            ...
            tonnage: 1488,
            speedKnots: 36,
            armorThickness: { belt: 12, deck: 7, turret: 6 },
            baseAccuracy: 74,
            stats: {
                health: this.calculateHP(1488, 'Destroyer'),
                armor: this.calculateArmor(12, 7, 6),
                speed: this.calculateSpeed(36),
        ...
        this.aiTypes.set('siren_clemenceau_dd', {
            ...
            tonnage: 1500,
            speedKnots: 35,
            armorThickness: { belt: 11, deck: 7, turret: 6 },
            baseAccuracy: 73,
            stats: {
                health: this.calculateHP(1500, 'Destroyer'),
                armor: this.calculateArmor(11, 7, 6),
                speed: this.calculateSpeed(35),
...
// ── LIGHT CRUISERS ────────────────────────────────────────────────────────────────
        ...
        this.aiTypes.set('siren_nagara', {
            ...
            tonnage: 5170,
            speedKnots: 36,
            armorThickness: { belt: 24, deck: 13, turret: 14 },
            baseAccuracy: 76,
            stats: {
                health: this.calculateHP(5170, 'Light Cruiser'),
                armor: this.calculateArmor(24, 13, 14),
                speed: this.calculateSpeed(36),
        ...
        this.aiTypes.set('siren_isuzu', {
            ...
            tonnage: 5500,
            speedKnots: 35,
            armorThickness: { belt: 22, deck: 13, turret: 12 },
            baseAccuracy: 78,
            stats: {
                health: this.calculateHP(5500, 'Light Cruiser'),
                armor: this.calculateArmor(22, 13, 12),
                speed: this.calculateSpeed(35),
        ...
        this.aiTypes.set('siren_kuma', {
            ...
            tonnage: 5100,
            speedKnots: 36,
            armorThickness: { belt: 22, deck: 12, turret: 13 },
            baseAccuracy: 75,
            stats: {
                health: this.calculateHP(5100, 'Light Cruiser'),
                armor: this.calculateArmor(22, 12, 13),
                speed: this.calculateSpeed(36),
        ...
        this.aiTypes.set('siren_cleveland', {
            ...
            tonnage: 11744,
            speedKnots: 32,
            armorThickness: { belt: 38, deck: 20, turret: 22 },
            baseAccuracy: 82,
            stats: {
                health: this.calculateHP(11744, 'Light Cruiser'),
                armor: this.calculateArmor(38, 20, 22),
                speed: this.calculateSpeed(32),
        ...
        this.aiTypes.set('siren_leander', {
            ...
            tonnage: 7270,
            speedKnots: 32,
            armorThickness: { belt: 32, deck: 18, turret: 20 },
            baseAccuracy: 79,
            stats: {
                health: this.calculateHP(7270, 'Light Cruiser'),
                armor: this.calculateArmor(32, 18, 20),
                speed: this.calculateSpeed(32),
        ...
        this.aiTypes.set('siren_fiji', {
            ...
            tonnage: 8530,
            speedKnots: 31,
            armorThickness: { belt: 35, deck: 19, turret: 22 },
            baseAccuracy: 80,
            stats: {
                health: this.calculateHP(8530, 'Light Cruiser'),
                armor: this.calculateArmor(35, 19, 22),
                speed: this.calculateSpeed(31),
        ...
        this.aiTypes.set('siren_emile_bertin', {
            ...
            tonnage: 5886,
            speedKnots: 39,
            armorThickness: { belt: 20, deck: 12, turret: 14 },
            baseAccuracy: 78,
            stats: {
                health: this.calculateHP(5886, 'Light Cruiser'),
                armor: this.calculateArmor(20, 12, 14),
...
// ── HEAVY CRUISERS ────────────────────────────────────────────────────────────────
        ...
        this.aiTypes.set('siren_mogami', {
            ...
            tonnage: 11200,
            speedKnots: 35,
            armorThickness: { belt: 50, deck: 26, turret: 30 },
            baseAccuracy: 82,
            stats: {
                health: this.calculateHP(11200, 'Heavy Cruiser'),
                armor: this.calculateArmor(50, 26, 30),
                speed: this.calculateSpeed(35),
        ...
        this.aiTypes.set('siren_myoukou', {
            ...
            tonnage: 13000,
            speedKnots: 34,
            armorThickness: { belt: 52, deck: 26, turret: 32 },
            baseAccuracy: 83,
            stats: {
                health: this.calculateHP(13000, 'Heavy Cruiser'),
                armor: this.calculateArmor(52, 26, 32),
                speed: this.calculateSpeed(34),
        ...
        this.aiTypes.set('siren_aoba', {
            ...
            tonnage: 7950,
            speedKnots: 34,
            armorThickness: { belt: 42, deck: 20, turret: 25 },
            baseAccuracy: 80,
            stats: {
                health: this.calculateHP(7950, 'Heavy Cruiser'),
                armor: this.calculateArmor(42, 20, 25),
                speed: this.calculateSpeed(34),
        ...
        this.aiTypes.set('siren_furutaka', {
            ...
            tonnage: 7950,
            speedKnots: 34,
            armorThickness: { belt: 38, deck: 19, turret: 23 },
            baseAccuracy: 79,
            stats: {
                health: this.calculateHP(7950, 'Heavy Cruiser'),
                armor: this.calculateArmor(38, 19, 23),
                speed: this.calculateSpeed(34),
                evasion: this.calculateEvasion(34, 7950),
                range: 12,
                baseAccuracy: 79
        ...
        this.aiTypes.set('siren_deutschland', {
            ...
            tonnage: 12000,
            speedKnots: 28,
            armorThickness: { belt: 60, deck: 32, turret: 38 },
            baseAccuracy: 85,
            stats: {
                health: this.calculateHP(12000, 'Heavy Cruiser'),
                armor: this.calculateArmor(60, 32, 38),
                speed: this.calculateSpeed(28),
        ...
        this.aiTypes.set('siren_norfolk', {
            ...
            tonnage: 9975,
            speedKnots: 32,
            armorThickness: { belt: 48, deck: 24, turret: 28 },
            baseAccuracy: 81,
            stats: {
                health: this.calculateHP(9975, 'Heavy Cruiser'),
                armor: this.calculateArmor(48, 24, 28),
                speed: this.calculateSpeed(32),
        ...
        this.aiTypes.set('siren_zara', {
            ...
            tonnage: 11870,
            speedKnots: 32,
            armorThickness: { belt: 58, deck: 32, turret: 38 },
            baseAccuracy: 82,
            stats: {
                health: this.calculateHP(11870, 'Heavy Cruiser'),
                armor: this.calculateArmor(58, 32, 38),
                speed: this.calculateSpeed(32),
        ...
        this.aiTypes.set('siren_zhusanuo', {
            ...
            tonnage: 10500,
            speedKnots: 30,
            armorThickness: { belt: 50, deck: 25, turret: 30 },
            baseAccuracy: 80,
            stats: {
                health: this.calculateHP(10500, 'Heavy Cruiser'),
                armor: this.calculateArmor(50, 25, 30),
                speed: this.calculateSpeed(30),
...
// ── BATTLESHIPS ───────────────────────────────────────────────────────────────────
        ...
        this.aiTypes.set('siren_kongou', {
            ...
            tonnage: 27500,
            speedKnots: 30,
            armorThickness: { belt: 75, deck: 28, turret: 48 },
            baseAccuracy: 83,
            stats: {
                health: this.calculateHP(27500, 'Battleship'),
                armor: this.calculateArmor(75, 28, 48),
                speed: this.calculateSpeed(30),
        ...
        this.aiTypes.set('siren_ise', {
            ...
            tonnage: 36000,
            speedKnots: 25,
            armorThickness: { belt: 82, deck: 32, turret: 52 },
            baseAccuracy: 84,
            stats: {
                health: this.calculateHP(36000, 'Battleship'),
                armor: this.calculateArmor(82, 32, 52),
                speed: this.calculateSpeed(25),
        ...
        this.aiTypes.set('siren_north_carolina', {
            ...
            tonnage: 36600,
            speedKnots: 28,
            armorThickness: { belt: 88, deck: 36, turret: 58 },
            baseAccuracy: 86,
            stats: {
                health: this.calculateHP(36600, 'Battleship'),
                armor: this.calculateArmor(88, 36, 58),
                speed: this.calculateSpeed(28),
        ...
        this.aiTypes.set('siren_colorado', {
            ...
            tonnage: 32500,
            speedKnots: 21,
            armorThickness: { belt: 85, deck: 34, turret: 55 },
            baseAccuracy: 85,
            stats: {
                health: this.calculateHP(32500, 'Battleship'),
                armor: this.calculateArmor(85, 34, 55),
                speed: this.calculateSpeed(21),
        ...
        this.aiTypes.set('siren_king_george_v', {
            ...
            tonnage: 36727,
            speedKnots: 28,
            armorThickness: { belt: 90, deck: 36, turret: 60 },
            baseAccuracy: 86,
            stats: {
                health: this.calculateHP(36727, 'Battleship'),
                armor: this.calculateArmor(90, 36, 60),
                speed: this.calculateSpeed(28),
        ...
        this.aiTypes.set('siren_bretagne', {
            ...
            tonnage: 23230,
            speedKnots: 20,
            armorThickness: { belt: 68, deck: 26, turret: 45 },
            baseAccuracy: 82,
            stats: {
                health: this.calculateHP(23230, 'Battleship'),
                armor: this.calculateArmor(68, 26, 45),
                speed: this.calculateSpeed(20),
...
// ── AIRCRAFT CARRIERS ─────────────────────────────────────────────────────────────
        ...
        this.aiTypes.set('siren_akagi', {
            ...
            tonnage: 36500,
            speedKnots: 31,
            armorThickness: { belt: 30, deck: 20, turret: 15 },
            baseAccuracy: 72,
            stats: {
                health: this.calculateHP(36500, 'Aircraft Carrier'),
                armor: this.calculateArmor(30, 20, 15),
                speed: this.calculateSpeed(31),
        ...
        this.aiTypes.set('siren_taihou', {
            ...
            tonnage: 29300,
            speedKnots: 33,
            armorThickness: { belt: 55, deck: 75, turret: 20 },
            baseAccuracy: 73,
            stats: {
                health: this.calculateHP(29300, 'Aircraft Carrier'),
                armor: this.calculateArmor(55, 75, 20),
                speed: this.calculateSpeed(33),
        ...
        this.aiTypes.set('siren_illustrious', {
            ...
            tonnage: 23207,
            speedKnots: 30,
            armorThickness: { belt: 50, deck: 65, turret: 20 },
            baseAccuracy: 71,
            stats: {
                health: this.calculateHP(23207, 'Aircraft Carrier'),
                armor: this.calculateArmor(50, 65, 20),
                speed: this.calculateSpeed(30),
        ...
        this.aiTypes.set('siren_bearn', {
            ...
            tonnage: 22146,
            speedKnots: 21,
            armorThickness: { belt: 30, deck: 18, turret: 10 },
            baseAccuracy: 70,
            stats: {
                health: this.calculateHP(22146, 'Aircraft Carrier'),
                armor: this.calculateArmor(30, 18, 10),
                speed: this.calculateSpeed(21),
...
// ── BOSSES ────────────────────────────────────────────────────────────────────────
        ...
        this.aiTypes.set('siren_boss_observer_alpha', {
            ...
            tonnage: 10000,
            speedKnots: 42,
            armorThickness: { belt: 28, deck: 18, turret: 16 },
            baseAccuracy: 90,
            stats: {
                health: this.calculateHP(10000, 'Destroyer'),
                armor: this.calculateArmor(28, 18, 16),
        ...
        this.aiTypes.set('siren_boss_tester_beta', {
            ...
            tonnage: 20000,
            speedKnots: 34,
            armorThickness: { belt: 55, deck: 30, turret: 32 },
            baseAccuracy: 90,
            stats: {
                health: this.calculateHP(20000, 'Light Cruiser'),
                armor: this.calculateArmor(55, 30, 32),
                speed: this.calculateSpeed(34),
        ...
        this.aiTypes.set('siren_boss_purifier', {
            ...
            tonnage: 80000,
            speedKnots: 23,
            armorThickness: { belt: 140, deck: 58, turret: 90 },
            baseAccuracy: 91,
            stats: {
                health: this.calculateHP(80000, 'Battleship'),
                armor: this.calculateArmor(140, 58, 90),
                speed: this.calculateSpeed(23),
        ...
        this.aiTypes.set('siren_boss_dreamweaver', {
            ...
            tonnage: 55000,
            speedKnots: 26,
            armorThickness: { belt: 65, deck: 50, turret: 30 },
            baseAccuracy: 82,
            stats: {
                health: this.calculateHP(55000, 'Aircraft Carrier'),
                armor: this.calculateArmor(65, 50, 30),
        ...
        this.aiTypes.set('siren_boss_omitter', {
            ...
            tonnage: 6000,
            speedKnots: 20,
            armorThickness: { belt: 40, deck: 25, turret: 18 },
            baseAccuracy: 92,
            stats: {
                health: this.calculateHP(6000, 'Submarine'),
                armor: this.calculateArmor(40, 25, 18),
                speed: this.calculateSpeed(20),
        ...
        this.aiTypes.set('siren_boss_complier', {
            ...
            tonnage: 28000,
            speedKnots: 32,
            armorThickness: { belt: 90, deck: 42, turret: 55 },
            baseAccuracy: 91,
            stats: {
                health: this.calculateHP(28000, 'Heavy Cruiser'),
                armor: this.calculateArmor(90, 42, 55),
                speed: this.calculateSpeed(32),
        ...
        this.aiTypes.set('siren_boss_arbiter_empress_iii', {
            ...
            tonnage: 40000,
            speedKnots: 27,
            armorThickness: { belt: 60, deck: 55, turret: 28 },
            baseAccuracy: 84,
            stats: {
                health: this.calculateHP(40000, 'Aircraft Carrier'),
                armor: this.calculateArmor(60, 55, 28),
                speed: this.calculateSpeed(27),
        ...
        this.aiTypes.set('siren_boss_arbiter_hierophant_v', {
            ...
            tonnage: 52000,
            speedKnots: 23,
            armorThickness: { belt: 122, deck: 50, turret: 80 },
            baseAccuracy: 91,
            stats: {
                health: this.calculateHP(52000, 'Battleship'),
                armor: this.calculateArmor(122, 50, 80),
                speed: this.calculateSpeed(23),
        ...
        this.aiTypes.set('siren_boss_arbiter_lovers_vi', {
            ...
            tonnage: 20000,
            speedKnots: 33,
            armorThickness: { belt: 75, deck: 38, turret: 48 },
            baseAccuracy: 90,
            stats: {
                health: this.calculateHP(20000, 'Heavy Cruiser'),
                armor: this.calculateArmor(75, 38, 48),
                speed: this.calculateSpeed(33),
        ...
        this.aiTypes.set('siren_boss_arbiter_strength_viii', {
            ...
            tonnage: 65000,
            speedKnots: 23,
            armorThickness: { belt: 132, deck: 54, turret: 85 },
            baseAccuracy: 92,
            stats: {
                health: this.calculateHP(65000, 'Battleship'),
                armor: this.calculateArmor(132, 54, 85),
                speed: this.calculateSpeed(23),
        ...
        this.aiTypes.set('siren_boss_arbiter_hermit_ix', {
            ...
            tonnage: 8000,
            speedKnots: 20,
            armorThickness: { belt: 50, deck: 32, turret: 22 },
            baseAccuracy: 93,
            stats: {
                health: this.calculateHP(8000, 'Submarine'),
                armor: this.calculateArmor(50, 32, 22),
                speed: this.calculateSpeed(20),
        ...
        this.aiTypes.set('siren_boss_arbiter_temperance_xiv', {
            ...
            tonnage: 48000,
            speedKnots: 28,
            armorThickness: { belt: 70, deck: 60, turret: 32 },
            baseAccuracy: 86,
            stats: {
                health: this.calculateHP(48000, 'Aircraft Carrier'),
                armor: this.calculateArmor(70, 60, 32),
                speed: this.calculateSpeed(28),
        ...
        this.aiTypes.set('siren_boss_arbiter_devil_xv', {
            ...
            tonnage: 75000,
            speedKnots: 21,
            armorThickness: { belt: 148, deck: 62, turret: 95 },
            baseAccuracy: 93,
            stats: {
                health: this.calculateHP(75000, 'Battleship'),
                armor: this.calculateArmor(148, 62, 95),
                speed: this.calculateSpeed(21),
        ...
        this.aiTypes.set('siren_boss_arbiter_tower_xvi', {
            ...
            tonnage: 90000,
            speedKnots: 20,
            armorThickness: { belt: 165, deck: 70, turret: 108 },
            baseAccuracy: 94,
            stats: {
                health: this.calculateHP(90000, 'Battleship'),
                armor: this.calculateArmor(165, 70, 108),
                speed: this.calculateSpeed(20),
