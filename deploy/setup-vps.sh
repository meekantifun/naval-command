...
echo "4. Configure Nginx: sudo cp deploy/nginx.conf /etc/nginx/sites-available/navalcommand"
echo "5. Enable site: sudo ln -s /etc/nginx/sites-available/navalcommand /etc/nginx/sites-enabled/"
echo "6. Setup SSL: sudo certbot --nginx -d navalcommand.com -d www.navalcommand.com"
